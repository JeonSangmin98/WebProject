...
<div class="panel-body">
	...
	<div class="editBtn">
		...
		<c:if
			test="${member.memberId != null && member.memberId == board.writer || member.memberId eq 'admin'}">
...
<div class="card mb-3">
	...
	<div class="card-reply-footer"></div>
</div>
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<label>작성자</label><input class="form-control" name="replyer"
						placeholder="${member.memberId}" value="${member.memberId}"
						disabled="disabled">
				</div>
				<div class="form-group">
					<label>작성일</label><input class="form-control" name="replyDate"
						value="2022-11-23" disabled>
				</div>
			</div>
