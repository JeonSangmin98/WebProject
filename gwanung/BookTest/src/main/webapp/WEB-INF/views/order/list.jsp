		...
		<div class="content_main">
						...
						<table>
							...
							<tbody>
								<tr>
									...
									<td><input class="addressee_input form-control"
										style="width: 300px; margin-left: 260px;"></td>
								</tr>
								<tr>
									<th scope="row" style="width: 500px;">주소</th>
									<td><input class="selectAddress" value="F" type="hidden"
										style="margin: 50px;"> <input
										class="address1_input form-control" readonly="readonly"
										style="width: 500px; margin-left: 85px; display: inline-block;">
									<button class="address_search_btn btn btn-info"
											onclick="execution_daum_address()"
											style="margin-left: 10px; margin-bottom: 5px; display: inline-block;">주소
											찾기</button>
										<br> <input class="address2_input form-control"
										readonly="readonly"
										style="width: 600px; margin-left: 100px; margin-top: 15px;"><br>
										<input class="address3_input form-control" readonly="readonly"
										style="width: 600px; margin-left: 100px; margin-top: -10px;">
									</td>
								</tr>
							</tbody>
						</table>
			...
			<div class="total_info_div">
				...
				<div class="total_info_price_div">
					<ul>
						<li><span class="price_span_label">상품금액</span> <span
							class="totalPrice_span">1000000</span>원</li>
						...
						<li><span class="price_span_label">할인금액</span> <span
							class="usePoint_span">1000000</span>원</li>
