...
<script>
	$(function() {
		...
		reviewUL.on('click','li', function(){
			var rno = $(this).data('rno');
			//console.log(rno);
			reviewService.get(rno, function(data){
				console.log(data);
				...
				review_modal.data("rno", data.rno);
				review_modal.modal("show");
