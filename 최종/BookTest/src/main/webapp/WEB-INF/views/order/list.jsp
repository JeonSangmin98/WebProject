				...
				<div class="col-lg-9">
					<div class="card">
						...
						<div class="member_info_div card-body">
							<table class="memberInfo_table table table-hover">
									<tr>
										...
										<td style="width:*" scope="col">${memberInfo.memberName} | ${memberInfo.memberMail}</td>
									</tr>
							</table>
							<div class="row">
								<div class="col-md-6">
									<button class="address_btn address_btn_1 btn btn-primary" onclick="showAdress('1')" >사용자 정보 주소록</button>
								</div>
								<div class="col-md-6">
									<button class="address_btn address_btn_2 btn btn-secondary" onclick="showAdress('2')">직접 입력</button>
								</div>
							</div>
						</div>
						<!-- 배송지 정보 -->
						<div class="card-body addressInfo_div">
							...
							<div class="card-body addressInfo_input_div addressInfo_input_div_2" style="display:none">
								<table>
									<colgroup>
										<col width="40%">
										<col width="*">
									...
									<tbody>
										<tr>
											<th scope="row" style="width: 500px;">이름</th>
											<td><input class="addressee_input form-control" style="width: 300px; margin-left: 260px;" ></td>
										</tr>
										<tr>
											<th scope="row" style="width: 500px;">주소</th>
											<td>
												<input class="selectAddress" value="F" type="hidden" style="margin: 50px;">	
												<input class="address1_input form-control" readonly="readonly" style="width: 500px; margin-left: 85px; display: inline-block;"><button class="address_search_btn" onclick="execution_daum_address()" style="margin-left: 10px; margin-bottom: 5px; display: inline-block;">주소 찾기</button><br>
												<input class="address2_input form-control" readonly="readonly" style=" margin-left: 100px; margin-top: 15px; width: 600px;"><br>
												<input class="address3_input form-control" readonly="readonly" style=" margin-left: 100px; margin-top: -10px; width: 600px;">
											</td>
										</tr>
									</tbody>
								</table>
						...
						<div class="card-body orderGoods_div">
							...
							<div class="goods_kind_div">
								<h4>주문상품 <span class="goods_kind_div_kind"></span>종 <span class="goods_kind_div_count"></span>권</h4>
							</div>
							<!-- 상품 테이블 --> 
									...
									<c:forEach items="${orderList}" var="ol">
										<tr>
											...
											<td class="goods_table_price_td">
												...
												<input type="hidden" class="individual_bno_input" value="${ol.bno}">
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<table class="point_table table table-hover">
								...
								<tbody>
									<tr>
										<th>포인트 사용</th>
										<td class="pinput">
											${memberInfo.point} | <input class="order_point_input form-control" value="0">원
											<button class="order_point_input_btn order_point_input_btn_N btn btn-primary" data-state="N">모두사용</button>
											<button class="order_point_input_btn order_point_input_btn_Y btn btn-secondary" data-state="Y" style="display: none;">사용취소</button>
										</td>
									</tr>
								</tbody>
							</table>
			...
			<div class="col-lg-3">
				<div class="card">				
					<div class="card-body login_success_area">
						...
						<div class="card-title">포인트 : <fmt:formatNumber value="${memberInfo.point}" pattern="#,###" /></div>
					</div>
				</div>
				<!-- 주문 종합 정보 -->
				<div class="card">
					<div class="card-body total_info_div">
						...
						<div class="total_info_price_div">
								<div>
									<span class="price_span_label"><b>상품금액  </b></span>
									<span class="totalPrice_span">1000000</span>원
								</div>
								<div>
									<span class="price_span_label"><b>배송비  </b></span>
									<span class="delivery_price_span">0</span>원
								</div>
								<div>
									<span class="price_span_label"><b>할인금액  </b></span>
									<span class="usePoint_span">1000000</span>원
								</div>
...
$(".order_btn").on("click",function(){
	...
	$(".goods_table_price_td").each(function(index, element){
		...
		let bno = $(element).find(".individual_bno_input").val();
