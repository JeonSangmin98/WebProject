...
${cartList}
	...
	<div class="container">
		...
		<!-- 구매 버튼 -->
		<button type="button" class="btn btn-primary order_btn"
	...
	<!-- 주문 form -->
	<form action="/order/list/${member.memberId}" method="get" class="order_form">
				...
				if(result == '0'){
					...
					$(".cartTotal").each(function(index, element){
						if($(element).find(".checkCart").is(":checked")===true){
							...
							let Bno_input = "<input name='orders[" + orderNumber + "].bno' type='hidden' value='" + bno + "'>";
